...
public class CityController {
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public ResponseEntity<Response<Integer>> updateCity(@RequestBody CityDto dto, @RequestParam("id") Long id) throws CityException {
        return ResponseEntity.status(HttpStatus.ACCEPTED).body(
                new Response.Builder<Integer>()
                        .message("City successfully updated")
                        .info(cityService.updateCity(dto, id))
                        .build()
        );
    }
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public ResponseEntity<Response<Integer>> deleteCity(@RequestParam("id") Long id) throws CityException {
        return ResponseEntity.status(HttpStatus.NO_CONTENT).body(
                new Response.Builder<Integer>()
                        .message("City successfully deleted")
                        .info(cityService.deleteCity(id))
                        .build()
        );
    }
}
